...
# 3. we create a list of stocks for which we donwnload the data
...
do
	...
	wget http://www.google.com/finance/historical?q=NYSE:GOOG&startdate=Jan+1,2008&enddate=Jan+1,2010&output=csv
